      ...
      <tbody>
          ...
          <tr>
              <td>
                  ...
                  <table border="0" bgcolor="#FA698E" cellpadding="0" cellspacing="0" width="640" role="presentation"
                      ...
                      <tbody>
                          <tr width="640" style="width: 640px; min-width: 640px; " align="center">
                              <td>
                                  <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                      style="width: 640px; min-width: 640px;" role="presentation" bgcolor="#FA698E">
                                      <tr>
                                      ...
                                      <tr>
                                          <td align="left">
                                              <table cellpadding="0" cellspacing="0" border="0" role="presentation"
                                                  align="center" bgcolor="#FA698E">
                                                  <tr>
                                                      <td>
                                                          <table cellpadding="0" cellspacing="0" border="0"
                                                              align="center" role="presentation"
                                                              style="background:#FA698E;">
                                                              <tr>
                                                                  <td align="center">
                                                                      <h2
                                                                          style="margin: 0px;font-size: 3rem;font-weight: 700;color: #fff;">
                                                                          The BFS
                                                                      </h2>
                                                                  </td>
                                                              </tr>
                                                          ...
                                                          <table cellpadding="0" cellspacing="0" border="0"
                                                              ...
                                                              role="presentation" bgcolor="#FA698E">
                                                              <tr>
                                                                  <td height="35"
                  ...
                  <table align="center" border="0" cellpadding="0" cellspacing="0" width="640" role="presentation"
                      bgcolor="#FFFFFF" class="table-container ">
                      <tbody>
                          <tr>
                              <td align="center">
...
${data?.products?.map((item) => {
  return `    <tr>
    ...
    item?.size?.name ? `-(${item?.size?.name})` : "(No Size Available)"
  } -(color : ${GetColorName(item?.color)}) - <span
  style="height: 18px;width: 18px;background: ${
    item?.color
  };border-radius: 20px;display: block;"></span>
            </td>
  ...
  } -  ${data?.shipping_address?.mobileno}
                                              </td>
                                          </tr>
                                      </tbody>
                                  </table>
